        ...
        "/documents": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Максимальное количество документов на странице (по умолчанию 20, макс 100)",
                        "name": "limit",
                        "in": "query"
                    },
                    {
        ...
        "/documents/{id}": {
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Failed to delete file or database record",
                        "schema": {
                            "type": "string"
                        }
                    }
        ...
        "/search": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Максимальное количество результатов (макс 100)",
                        "name": "limit",
                        "in": "query"
                    }
                ],
